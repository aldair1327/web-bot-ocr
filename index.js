...
async function prueba(){
    let driver = await new Builder().forBrowser("firefox").build(); //navegador web a utilizar
    await driver.get("https://www.newocr.com/"); // página web a la que se desea accesar
    await driver.findElement(By.id("userfile")).sendKeys('C:\\Selenium\\imagenes\\prueba.jpg'); // documento a subir
